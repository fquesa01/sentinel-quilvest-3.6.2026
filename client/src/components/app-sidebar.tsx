      ...
      items: [
        {
          ...
          roles: ["admin", "cro", "risk_manager", "compliance_officer", "auditor"],
        },
        {
          title: "Risk Register",
        ...
        },
        {
          ...
          url: "/risk-management/assessments",
          icon: Target,
          roles: ["admin", "cro", "risk_manager", "compliance_officer"],
        },
        {
          title: "Key Risk Indicators",
          url: "/risk-management/kris",
          icon: TrendingUp,
          roles: ["admin", "cro", "risk_manager", "compliance_officer"],
        },
        {
          title: "Risk Appetite",
          url: "/risk-management/risk-appetite",
          icon: Target,
          roles: ["admin", "cro", "risk_manager"],
        },
        {
          title: "Bow-Tie Analysis",
          url: "/risk-management/bow-tie",
          icon: Network,
          roles: ["admin", "cro", "risk_manager", "compliance_officer"],
        },
        {
          title: "Business Continuity",
          url: "/risk-management/bcp",
          icon: Briefcase,
          roles: ["admin", "cro", "risk_manager", "compliance_officer"],
        },
        {
          title: "Controls",
          url: "/risk-management/controls",
          icon: Shield,
          roles: ["admin", "cro", "risk_manager", "compliance_officer", "auditor"],
        },
        {
          title: "Incidents",
          url: "/risk-management/incidents",
          icon: AlertTriangle,
          roles: ["admin", "cro", "risk_manager", "compliance_officer"],
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: "/mailbox",
          icon: Mail,
          roles: ["admin", "compliance_officer", "attorney", "external_counsel", "auditor"],
          showBadge: true,
        },
        {
        ...
        {
          title: "Employee & Vendor Monitoring",
          url: "/monitoring/directory",
          icon: Users,
          roles: ["admin", "compliance_officer", "attorney"],
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: "/reports/communications",
          icon: BarChart3,
          roles: ["admin", "attorney", "compliance_officer", "auditor"],
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: "/regulatory-changes",
          icon: Scale,
          roles: ["admin", "compliance_officer", "attorney", "auditor"],
        },
        {
          title: "Remediation Plans",
          url: "/remediation-plans",
          icon: ClipboardList,
          roles: ["admin", "attorney", "compliance_officer"],
        },
        {
          title: "Regulatory Strategies",
          url: "/regulatory-strategies",
          icon: Target,
          roles: ["admin", "attorney", "compliance_officer"],
        },
        {
          title: "Disclosure Playbooks",
          url: "/disclosure-playbooks",
          icon: FileText,
          roles: ["admin", "attorney", "compliance_officer"],
        },
        {
