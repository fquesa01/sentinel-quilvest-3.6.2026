 ...
 * 
 * Usage: npx tsx server/seed-production.ts
 * 
 * What it seeds:
...
import { seedMonitoringData } from "./seed-monitoring-demo-data.js";
...
async function seedProduction() {
  ...
  try {
    ...
    const existingEmployees = await db.select().from(schema.employees).limit(1);
    if (existingEmployees.length > 0) {
      console.log("Employees & Vendors already seeded, skipping...");
    } else {
...
VP Business Development`,
        ...
        legalHold: "active" as const,
        sourceType: "email_m365" as const,
      },
      {
        communicationType: "email" as const,
        subject: "Re: Singapore Contract - Meeting with Minister Lee",
...
Wire Transfer Department`,
      ...
      // Insider Trading
      {
        communicationType: "chat" as const,
        subject: "Teams Chat - Mike Johnson and Sarah Wilson",
...
Mike: Your call. I'm buying 10,000 shares tomorrow. Gonna make $200K easy`,
        ...
        legalHold: "active" as const,
        sourceType: "chat_teams" as const,
      },
    ];
    ...
    const interviewsData = [
      {
        caseId: cases[0]?.id,
        interviewType: "investigative" as const,
        ...
        meetingLink: "Conference Room A - New York Office",
        interviewerIds: [adminUserId],
        notes: "Interview with VP Business Development regarding FCPA investigation",
        isPrivileged: "true",
      ...
      },
      {
        ...
        interviewerIds: [adminUserId],
        notes: "Interview with VP Sales regarding antitrust investigation",
        isPrivileged: "true",
        upjohnWarningGiven: "false",
      },
      {
        ...
        intervieweeJurisdiction: "Massachusetts",
        scheduledFor: new Date("2025-11-20T09:30:00Z"),
        meetingLink: "Attorney Office - 100 State St, Boston, MA",
        interviewerIds: [adminUserId],
        notes: "Interview with CFO regarding SOX investigation",
        isPrivileged: "true",
        upjohnWarningGiven: "false",
      },
    ];
