-- =============================================================================
-- PRODUCTION DATABASE - ADD MISSING COLUMNS TO EXISTING TABLES
-- =============================================================================
-- Run this after the main migration to add any columns to tables that already exist
...
DO $$ BEGIN 
  ALTER TABLE notifications ADD CONSTRAINT notifications_recipient_user_id_fkey FOREIGN KEY (recipient_user_id) REFERENCES users(id);
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
ALTER TABLE users ADD COLUMN IF NOT EXISTS role VARCHAR DEFAULT 'compliance_officer';
ALTER TABLE users ADD COLUMN IF NOT EXISTS created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE users ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;

-- Add unique constraint on microsoft_id if not exists
DO $$ BEGIN 
...
-- DONE
-- =============================================================================
-- After running this, try these operations on sntlabs.io:
-- 1. Login should work
-- 2. Create a new case
